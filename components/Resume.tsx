...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    period: '2024 - 2025',
    description: 'This is a mock experience entry for demonstration purposes in the portfolio.',
    technologies: ['MockTech1', 'MockTech2']
  },
  {
...
const education: Education[] = [
  ...
  },
  {
    ...
    period: '2020 - 2024',
    description: 'This is a mock education entry for demonstration purposes.',
    gpa: '10/10'
  },
  {
  ...
  return (
    <section id="resume" className="min-h-screen py-20 relative overflow-hidden">
      ...
      <div ref={ref} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              ...
              <span className="text-responsive-sm">Download Resume</span>
            </motion.button>
            <motion.button
            ...
            >
              ...
              <span className="text-responsive-sm">View Resume</span>
            </motion.button>
          </div>
        </motion.div>
        ...
        >
          <h3 className="text-responsive-xl font-bold mb-4 gradient-text">Professional Summary</h3>
          <p className="text-responsive-md leading-relaxed opacity-90">
          ...
          >
            <div className="glass-card p-8 rounded-xl">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-responsive-xl font-bold gradient-text">Experience</h3>
              </div>
              ...
              <div className="space-y-8">
                {experiences.map((exp, index) => (
                  ...
                  >
                    ...
                    <div className="mb-3">
                      <h4 className="text-responsive-md font-bold">{exp.title}</h4>
                      <div className="flex items-center text-purple-400 font-medium text-responsive-sm mb-1">
                        <span>{exp.company}</span>
                      </div>
                      <div className="flex items-center text-responsive-xs opacity-70">
                        <Calendar className="w-3 h-3 mr-1" />
                        <span>{exp.period}</span>
                      </div>
                    </div>
                    <p className="text-responsive-sm opacity-90 mb-3 leading-relaxed">{exp.description}</p>
                    {exp.technologies && (
          ...
          >
            ...
            <div className="glass-card p-8 rounded-xl">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-responsive-xl font-bold gradient-text">Education</h3>
              </div>
              ...
              <div className="space-y-6">
                {education.map((edu, index) => (
                  ...
                  >
                    ...
                    <div className="mb-2">
                      <h4 className="text-responsive-md font-bold">{edu.degree}</h4>
                      <div className="flex items-center text-blue-400 font-medium text-responsive-sm mb-1">
                    ...
                    <p className="text-responsive-sm opacity-90">{edu.description}</p>
                  </motion.div>
                ))}
              </div>
            </div>
            ...
            <div className="glass-card p-8 rounded-xl">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-responsive-xl font-bold gradient-text">Key Projects</h3>
              </div>
              ...
              <div className="space-y-4">
                {projects.map((project, index) => (
                  ...
                  >
                    <h4 className="font-bold text-responsive-sm mb-2">{project.name}</h4>
                    <p className="text-responsive-xs opacity-80 mb-2">{project.description}</p>
                    <div className="flex items-center text-green-400 text-responsive-xs">
        ...
        >
          <div className="flex items-center mb-6">
            ...
            <h3 className="text-responsive-xl font-bold gradient-text">Key Achievements</h3>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {achievements.map((achievement, index) => (
              ...
              >
                ...
                <p className="text-responsive-sm opacity-90">{achievement}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
