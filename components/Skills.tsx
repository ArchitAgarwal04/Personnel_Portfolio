...
const skillsData = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Next.js 13/14/15 (App Router, Server Actions)', level: 90 },
      { name: 'TypeScript', level: 85 },
      { name: 'Tailwind CSS', level: 90 },
      { name: 'HTML5, CSS3', level: 95 },
      { name: 'Framer Motion (animations)', level: 80 },
      { name: 'Zustand / Redux (state management)', level: 80 }
    ]
  },
  {
    icon: '🌐',
  ...
  },
  {
    ...
    title: 'Design & UX',
    skills: [
      { name: 'Responsive Design (Mobile-first)', level: 90 },
      { name: 'CSS Animations', level: 85 },
      { name: 'Gradient effects, dark/light mode handling', level: 80 }
    ]
  },
  {
    icon: '🧩',
  ...
  },
  {
    ...
    skills: [
      { name: 'Codeforces – Pupil', level: 70 },
      { name: 'LeetCode – Knight', level: 75 }
    ]
  }
];
